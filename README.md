...
elsewhere on the Internet. Sometimes this is a Domain Name Service (DNS) code, and other times it's a "social proof" or
authentication tag in a well-known or easily-verified location.

GitHub doesn't currently allow "gists" to belong to an organization, while also restricting certain HTML tags from
